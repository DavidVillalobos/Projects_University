...
import com.food_service.logic.ClienteDetails ;
...
public class Dao_Cliente_Details {
    ...
    private ClienteDetails  render_cliente_details(ResultSet rs){
        try {
            ...
            p.setDetails(Dao_Details.instance().get(rs.getInt("detail")));
            p.setClienteAdditionals(Dao_Cliente_Additionals.instance().get(rs.getInt("cliente_additional")));
            return p;
        } catch (Exception ex) {
            return null;
        }
